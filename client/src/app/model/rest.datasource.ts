...
export class RestDataSource {
  ...
  saveIncident(incident: Incident): Observable<Incident> {
    return this.http.post<Incident>(this.baseUrl + "incident-list",
      incident, this.getOptions());
  }

  updateIncident(incident: Incident): Observable<Incident> {
    return this.http.put<Incident>(`${this.baseUrl}incident-list/${incident._id}`,
      incident, this.getOptions());
  }

  deleteIncident(id: number): Observable<Incident> {
    return this.http.delete<Incident>(`${this.baseUrl}incident-list/${id}`,
      this.getOptions());
  }
